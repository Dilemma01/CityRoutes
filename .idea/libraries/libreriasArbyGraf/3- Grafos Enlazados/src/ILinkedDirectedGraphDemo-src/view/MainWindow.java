...
import model.visualgraph.VisualDirectedGraph;
...
public class MainWindow {
	...
	ILinkedDirectedGraph graph;
	private VisualDirectedGraph visualGraph;
	...
	private void initialize() {
		...
		visualGraph = new VisualDirectedGraph(frmMain.getWidth()/2, frmMain.getHeight()/2-120);
		...
		tableVertModel.addColumn(Messages.getString("MainWindow.InGrade"));
		tableVertModel.addColumn(Messages.getString("MainWindow.OutGrade"));
	...
	private void deleteSelectedEdge(int index) {
		...
		char info2 = edge.charAt(5);
		int index1 = getVertexIndexForValue(info1);
		int index2 = getVertexIndexForValue(info2);
		
		graph.deleteEdgeD(index1, index2);	
		visualGraph.deleteEdgeD(index1, index2);
	}
	...
	private void refreshVerticesTable() {
		...
		while(iter.hasNext()) {
			...
			row.add(String.valueOf(graph.degreeDG(index)));
			row.add(String.valueOf(graph.inDegreeDG(index)));
			row.add(String.valueOf(graph.outDegree(index)));
	...
	private void deleteDisconnecteds() {
		graph.removeDisconnectVerticesDG();
